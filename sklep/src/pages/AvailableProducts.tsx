        ...
        {data.map((product, i) => {
          return (
            <div
              key={i}
              id={product.id}
              className="product w-[100%] relative cursor-pointer bg-[#f1f1f1] pb-2 group">
              ...
              <div className="flex my-3 space-x-5 ml-5">
                <button className="border-[1px] border-black px-4 py-2 bg-black text-white font-brunoAce hover:rounded-lg transition-all duration-200">
                  EDYTUJ
                </button>
                <button className="border-[1px] border-black px-4 py-2 bg-[#ffffff] font-brunoAce hover:rounded-lg transition-all duration-200">
                  {" "}
                  USUŃ
                </button>
              </div>
