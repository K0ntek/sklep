...
return(
    <div className="pt-12 bg-black w-full">
        ...
        <div className="grid md:grid-cols-3">
            <div className="mx-auto justify-center text-center">
                ...
                <img src={logo} alt="logo" className="w-[50px] mx-auto"/>
                    ...
                    <p className="text-white text-justify w-[80%] mx-auto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus dolore hic accusantium? Sapiente cupiditate voluptates voluptas iusto amet expedita ducimus?</p>
                    
                            <div className="flex text-center  justify-center my-2 space-x-5">
                                <div className="flex text-white"><FiMail className="mt-1 mx-1 text-[#f0b338]"/> <p>e-mail</p></div>
                                <div className="flex text-white"><BsFillTelephoneFill className="mt-1 mx-1 text-[#f0b338]"/><p>numer telefonu</p></div>
                            </div>

                    <p className=" text-white mt-4 text-[18px] font-gruppo bg-black">Copyright © 2023 WNETRZA Z KLASA by <span className="text-[#c93] font-gruppo font-bold">Jakub Kontek</span></p>
            ...
            <div className="justify-center text-white">
                ...
                <div className="w-fit text-center mb-7 mt-4  mx-auto">
                    <h1 className=" font-gruppo text-[#f0b338] text-2xl">ZAOBSERWUJ</h1>
                            <div className=" text-white flex space-x-2.5 text-2xl text-start my-1">
                                <BsFacebook className=" hover:text-[#ffb92c] transition-all duration-200"/>
                                <FiInstagram className=" hover:text-[#ffb92c] transition-all duration-200"/>
                                <AiFillTwitterCircle className= "hover:text-[#ffb92c] transition-all duration-200"/>
                            </div>
                </div>
            </div>
        ...
        <div className="w-full flex space-x-[50px] justify-center text-[12px] py-5 font-arial text-white bg-[#020202] text-center">
