    ...
    <div className="pt-12 bg-black w-full">
          ...
          <div className="mx-auto justify-center text-center">
            ...
            <div className="flex text-center  justify-center my-2 space-x-5">
              <div className="flex text-white">
                <FiMail className="mt-1 mx-1 text-[#b38e45]" /> <p>e-mail</p>
              </div>
              <div className="flex text-white">
                <BsFillTelephoneFill className="mt-1 mx-1 text-[#b38e45]" />
                <p>numer telefonu</p>
              </div>
            </div>
          </div>
                  ...
                  {garden.map((element, i) => {
                    return (
                      <li key={i}>
                        ...
                        <a
                          href={element.link}
                          className=" text-sm text-[#919191] hover:text-[#c93]">
                          {element.title}
                        </a>
                      </li>
                    );
      ...
      <div className="bg-[#050505]">
        <div className="w-[90%] text-center mx-auto">
          <p className=" text-white mt-4 text-[18px] font-gruppo">
            Copyright © 2023 WNETRZA Z KLASA by{" "}
            <span className="text-[#c93] font-gruppo font-bold">Jakub Kontek</span>
          </p>
          <div className="mb-4">
            <a
              href="http://www.freepik.com"
              className="text-[11px] text-[#c93] font-gruppo font-bold">
              IMAGE BY FREEPIK
            </a>
          </div>
        </div>
        ...
        <div className="w-full flex space-x-[50px] justify-center text-[12px] py-5 font-arial text-white text-center">
          <div className="w-fit group">
            <a href="" className="hover:text-[#c93] py-[5px] transition-all duration-200">
              REGULAMIN
            </a>
