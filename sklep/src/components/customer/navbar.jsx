...
const Navbar =()=>{
    ...
    const toggleInformation =()=>{
        gsap.to('.log-in', {top: '30px', opacity:1, duration:.1})
    }

    const hideInformation =()=>{
        gsap.to('.log-in', {top: '10px', opacity:0, duration:.1})
    }
    ...
    return(
       <>
        ...
        <div className="flex text-[35px] ml-[30px] space-x-[5px]">
                   ...
                   <Link to={'/register'}> <IoPersonCircleSharp className="cursor-pointer rounded-full p-[5px] hover:bg-gray-300 hover:text-white transition-all duration-200"/>
                   <p className=" font-brunoAce bg-white p-2 text-lg z-[99] absolute top-[70px] hidden  lg-block">Zaloguj się </p></Link>
            </div>
         ...
         <div className="w-full h-[60px] fixed top-0  text-black bg-white z-[70] navbar">
            ...
            <Link to={'/'}><img src={logo} alt="logo.png" className=" h-[45px]"/></Link>
                    ...
                    <div className="text-[30px] ml-[30px] space-x-[5px] hidden lg:flex">
                            <BiShoppingBag className="cursor-pointer rounded-full p-[5px] hover:bg-gray-300 hover:text-white transition-all duration-200" onClick={toggleBasket}/>
                            <div><Link to={'/register'}> <IoPersonCircleSharp onMouseEnter={toggleInformation} onMouseLeave={hideInformation} className="person cursor-pointer rounded-full p-[5px] hover:bg-gray-300 hover:text-white transition-all duration-200"/></Link>
                                <p className="w-[80px] log-in font-brunoAce text-[10px] absolute z-[-10] ml-[-20px] top-[-5px] text-center opacity-0 group-hover:opacity-100 group-hover:top-[30px] transition-all duration-200">Zaloguj się </p>
                            </div>
                    </div>
                    </div>
                    ...
                    <div className="basket fixed top-[60px] right-[-100%] w-[100%] md:w-[70%] xl:w-[40%] 2xl:w-[30%] h-screen bg-[#fcfcfc] z-[90]">
                        ...
                        <div className=" h-[100%]">
                            ...
                            <div className="w-[90%] mx-auto absolute bottom-[10%] left-[5%] ">
                               <Link to={'/summary'}> <button className="w-full py-4 mx-auto z-[99] text-white bg-black hover:rounded-2xl transition-all duration-150">KUP TERAZ</button></Link>
                            </div>
                        </div>
                    </div>
                </div>   
